        ...
        <div className=" w-full pt-4 pb-24 px-2 md:px-10 lg:px-10">
           <div className="flex flex-col md:flex-row justify-between items-center ">
                <div className=" py-16 px-2 md:px-10 lg:px-10 w-full md:w-120">
                    ...
                    <h2 className="text-3xl mb-4 md:text-4xl font-semibold text-gray-900">We are Experts Learning Institution</h2>
                    ...
                    <h2 className="text-3xl mb-4 md:text-4xl font-semibold text-gray-900">Our Goal</h2>
                    ...
                    <h2 className="text-3xl mb-4 md:text-4xl font-semibold text-gray-900">Our Mission</h2>
                    ...
                    <h2 className="text-3xl mb-4 md:text-4xl font-semibold text-gray-900">Our vission</h2>
                ...
                <div className="transition-opacity duration-1000 ease-in-out flex justify-end w-full md:mt-0">
                    <img src={ocohstech_background}  alt="img" className="w-full md:w-[500px] h-[400px] md:h-[800px] object-cover rounded-lg" />
                </div>
           </div>
        </div>
    )
