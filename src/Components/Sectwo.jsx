...
const Sectwo = () => {
    ...
    return (
        <div className=" w-full pt-4 pb-24 px-2 md:px-10 lg:px-16">
           <div className="flex flex-col md:flex-row justify-between items-center ">
                <div className=" py-16 px-2 md:px-10 lg:px-10 w-full md:w-120">
                    <h3
                    ref={ref}
                    className={`transition-opacity duration-1000 ease-in-out text-emerald-600 font-bold mb-4  ${inView ? 'slide-in-from-left' : 'opacity-0'}`}>About Us</h3>
                ...
                <div className="transition-opacity duration-1000 ease-in-out flex justify-end w-full md:mt-0">
                    <img src={img2}  alt="img" className="w-full md:w-[500px] h-[400px] md:h-[800px] object-cover rounded-lg" />
                </div>
           </div>
        </div>
    )
